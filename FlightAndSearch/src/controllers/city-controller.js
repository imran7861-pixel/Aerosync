...
const create = async (req, res) => {
    try {
        ...
        return res.status(500).json({
            data: {},
            success: false,
            message: 'Error occured while creating a city ',
            err: {error}
        }); 
    }
}
...
const update = async (req, res) => {
    try {
        ...
        return res.status(500).json({
            data: {},
            success: false,
            message: 'Error occured while updating a city',
            err: {error}
        });
    }
}
...
const getAll = async (req, res) => {
    try {
        ...
        return res.status(500).json({
            data: {},
            success: false,
            message: 'Error occured while getting a city',
            err: {error}
        });
    }
}
...
//             data: {},
//             success: false,
//             message: 'Error occured while creating many cities',
//             err: {error}
//         });
//     }
// }
